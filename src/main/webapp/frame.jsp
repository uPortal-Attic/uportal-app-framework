    ...
    <noscript>
      ...
      <div class="container-fluid" id="body-background">
        ...
        <div class="row page-content">
          ...
          <div ng-if="(!($storage.showSidebar)) && APP_FLAGS.showSidebar" class="show-sidebar" ng-click="$storage.showSidebar = true" onClick="pushGaEvent('Sidebar','Maximize Sidebar', 'Maximize Sidebar')">
