define(['angular', 'jquery', 'portal', 'portal/main/route', 'portal/settings/route', 'portal/notifications/route', 'portal/features/route'], function(angular, $, portal, main, settings, notifications, features) {
    /*
