...
- **titleUrl**: *(experimental, optional)* A url which, when called successfully, will supply the title text for this notification. If the url returns an error, null, or empty array - the notification does not display. 
