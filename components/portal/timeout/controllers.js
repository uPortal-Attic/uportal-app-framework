...
define(['angular'], function(angular) {
  return angular
      .module('portal.timeout.controllers', [])
      .controller('PortalTimeoutController', [
         ...
         */
          function checkInactive() {
            ...
            var warningInactiveDuration = toMillis(
                appInactiveTimeout - 2 * checkInactiveDelay
            );
            var dialogInactiveDuration = toMillis(
                appInactiveTimeout - checkInactiveDelay
            );
            ...
            // Trigger dialog with one minute on the clock
              $timeout(
                  triggerDialog,
                  dialogInactiveDuration - inactiveDuration,
                  false
              );
            }
          }
