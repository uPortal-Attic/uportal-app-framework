        ...
        .controller('PortalMainController', [
           ...
           */
            function updateWindowTitle(pageTitle) {
              ...
              var windowTitle = mainService.computeWindowTitle(
                  pageTitle,
                  appTitle,
                  portalTitle
              );
    ...
    /* Username */
        .controller('SessionCheckController', [
          ...
          function(
            ...
            // Tell username menu which element to focus upon opening
            // (accessibility)
           ...
           */
            ...
            mainService
                ...
                .then(function(result) {
                  ...
                  ? vm.user.firstName.toLowerCase()
                  : vm.user.displayName.toLowerCase();
                  }
           ...
           */
            vm.trapFocus = function(event, position) {
              var anchor = angular.element(
                  '.main-menu__focus-anchor' + position
              );
           ...
           */
            ...
            // Use either custom template or defined menu items
              if (APP_OPTIONS.appMenuTemplateURL) {
                vm.appMenuTemplate = require.toUrl(
                    APP_OPTIONS.appMenuTemplateURL
                );
              } else if (
                APP_OPTIONS.appMenuItems &&
              APP_OPTIONS.appMenuItems.length > 0
              ) {
              ...
              $rootScope.portal.theme.footerLinks
                ...
                vm.footerLinks = vm.footerLinks.concat(
                    $rootScope.portal.theme.footerLinks
                );
              }
            ...
            // otherwise hide messages features
              ...
              // Set flags for notifications/announcements
                vm.hasPriorityNotifications =
                $localStorage.hasPriorityNotifications;
                vm.hasUnseenAnnouncements = $localStorage
