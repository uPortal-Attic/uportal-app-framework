                ...
                promises.push(
                    $http
                      ...
                      angular.isArray(message.data.dataMessageTitle)
                            ...
                            var messageTitleLocation = message.data.dataMessageTitle;
                            angular.forEach(messageTitleLocation, function(
                                value,
                                key
                            ) {
                      ...
                      message.moreInfoButton &&
                      angular.isArray(message.data.dataMessageMoreInfoUrl)
                          ) {
                            var messageMoreInfoUrl = objectToFind;
                            var messageMoreInfoUrlLocation =
                        message.data.dataMessageMoreInfoUrl;
                            angular.forEach(messageMoreInfoUrlLocation, function(
                                value,
                                key
                            ) {
                          ...
                          if (result && message.data.dataObject) {
                            objectToFind = objectToFind[message.data.dataObject];
                          }
