      ...
      .config([
        ...
        function(
          ...
          gravatarServiceProvider.defaults = {
            default:
            'https://yt3.ggpht.com/-xE0EQR3Ngt8/AAAAAAAAAAI/AAAAAAAAAAA/zTofDHA3-s4/s100-c-k-no/photo.jpg',
          };
        ...
        var themeLoading = function() {
              ...
              $http
                  ...
                  .then(function(result) {
                    ...
                    for (var i = 0; i < THEMES.themes.length; i++) {
                      ...
                      if ('default' !== groupToTest) {
                        // skip the default theme
                        var filterTest = filterFilter(groups, {
                          name: groupToTest,
                        });
                  ...
                  .catch(function(reason) {
                    if (APP_FLAGS.debug) {
                      $log.error(
                          'We got a error back from groupURL,' +
          ...
          // themeindex is a theme name, search!
            ...
            if (theme) {
              ...
              if (APP_FLAGS.debug) {
                $log.warn(
                    'APP_FLAGS.defaultTheme was set to ' +
                  themeIndex +
            ...
            // theme default
            $rootScope.portal.theme = THEMES.themes[themeIndex];
            generateTheme();
            loadingCompleteSequence();
          }
        };
        ...
        var configureAppConfig = function() {
          ...
          for (var i = 0; i < configsName.length; i++) {
            ...
            if (OVERRIDE[curConfig]) {
              groups++;
              if (angular.isArray(configs[i])) {
              // arrays are special, append
          ...
          if (APP_FLAGS.debug) {
            ...
            $log.info(
                'Overwrote ' + count + ' configs in ' + groups +
                ' config groups.'
            );
          }
        };
