      ...
      .factory('widgetService', [
          ...
          // configuration backwards compatibility
            ...
            return $http
                ...
                .catch(function(error) {
                  $log.warn(
                      'WIDGET SERVICE: Error getting app directory entry for ' + fname
                  );
         ...
         */
          var getErrorPage = function(fname) {
            return {
              ...
              widgetTemplate:
              '<div class=\'overlay__widget-mode\'>' +
         ...
         */
          var getWidgetExternalMessage = function(widget) {
            var externalMessage = {};
            return $http
                .get(widget.widgetExternalMessageUrl, {cache: true})
                .then(function(result) {
                  if (
                    widget.widgetExtneralMessageTextObjectLocation &&
                angular.isArray(widget.widgetExtneralMessageTextObjectLocation)
                  ...
                  if (
                    widget.widgetExternalMessageLearnMoreUrl &&
                ...
                .catch(function(error) {
                  $log.warn(
                      'WIDGET SERVICE: Couldn\'t retrieve external message for: ' +
                  widget.fname
                  );
                  return null;
                });
         ...
         */
          var getWidgetJson = function(widget) {
            return $http
                .get(widget.widgetURL, {cache: true})
                .then(function(result) {
                ...
                .catch(function(error) {
                  $log.warn(
                      'WIDGET SERVICE: Couldn\'t get widget json. ' + error.status
                  );
                });
          };
         ...
         */
          var getRssAsJson = function(url) {
            return $http
                ...
                .catch(function(error) {
                  $log.warn(
                      'WIDGET SERVICE: Couldn\'t get RSS as json. ' + error.status
                  );
                });
          };
         ...
         */
          var getActionItemQuantity = function(url) {
            return $http
                ...
                .catch(function(error) {
                  $log.warn(
                      'WIDGET SERVICE: Couldn\'t get action item quantity. ' +
                  error.status
                  );
                });
          };
