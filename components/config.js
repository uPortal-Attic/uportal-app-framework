...
define(['./my-app/app-config.js'], function(myAppConfig) {
  ...
  var framePaths = {
    'angular':
      'https://cdnjs.cloudflare.com/ajax/libs/angular.js/1.7.2/angular.min',
    'angular-animate':
      'https://cdnjs.cloudflare.com/ajax/libs/angular.js/1.7.2/angular-animate.min',
    'angular-mocks':
      'https://cdnjs.cloudflare.com/ajax/libs/angular.js/1.7.2/angular-mocks',
    'angulartics':
    ...
    'ngAria':
      'https://cdnjs.cloudflare.com/ajax/libs/angular.js/1.7.2/angular-aria.min',
    'ngMaterial':
      'https://cdnjs.cloudflare.com/ajax/libs/angular-material/1.1.1/angular-material.min',
    'ngRoute':
      'https://cdnjs.cloudflare.com/ajax/libs/angular.js/1.7.2/angular-route.min',
    'ngSanitize':
      'https://cdnjs.cloudflare.com/ajax/libs/angular.js/1.7.2/angular-sanitize.min',
    'ngStorage':
